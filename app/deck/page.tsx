...
const _dummyText = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent bibendum, lorem vel tincidunt imperdiet, nibh\n' +
...
export default function Page () {
  ...
  return <div className="flex items-center justify-center min-h-screen p-4 gap-16">
    <main className="flex flex-row gap-8 justify-center items-center flex-wrap w-full">
      {deckList.map((elt) => <Deck key={elt.id} title={elt.title} text={elt.description} onClick={() => onClick(elt)}/>
      )}
    </main>
  </div>
}